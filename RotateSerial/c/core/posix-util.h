...
static inline size_t count_slices_posix(FILE *f, size_t nbytes_slice) {
...
static inline size_t count_slices_pathname_posix(const char *pathname,
                                                 size_t nbytes_slice) {
  FILE *f;
